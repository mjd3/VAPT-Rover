 ...
 * The application should also register a BroadcastsReceiver for notification of
...
public class WiFiDirectActivity extends Activity implements DeviceActionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // set the application's mHomeAcitivity to be this activity
    ...
    public void startRoverActivity(){
        Log.d(TAG, "startRoverActivity : ");
        Intent i = mApp.getLaunchActivityIntent(RoverActivity.class, null);
        startActivity(i);
    }

    public void startRCActivity(){
        Log.d(TAG, "startRCActivity : ");
        Intent i = mApp.getLaunchActivityIntent(RemoteControllerActivity.class, null);
        startActivity(i);
    }
}
