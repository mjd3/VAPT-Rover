...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.device_list_bt);
        ...
        ArrayAdapter<String> pairedDevicesAdapter = new ArrayAdapter<String>(this, R.layout.device_name_bt);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.device_name_bt);
