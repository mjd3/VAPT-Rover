...
/**
 ** This WorkHandler handles the application's requests to initialize the WifiDirect API through the P2P manager
 ** It's used by the ConnectionService when connection is first created, when P2P_STATE_ENABLED, or upon a disconnect to try to reinitialize
 */
